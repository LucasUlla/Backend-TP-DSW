...
app.use(cors({
  origin: 'http://localhost:5173', // el puerto donde corre tu Vite dev server
  credentials: true // solo si usás cookies/sesiones; si usás JWT en headers, no hace falta
}));
